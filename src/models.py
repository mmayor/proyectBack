...
class Profile(db.Model):
    ...
    recipes = db.relationship("Receta_Ingrediente", back_populates="profile")
    stocks = db.relationship("Stock", back_populates="profile")
...
class Receta_Ingrediente(db.Model):
    ...
    id_ingrediente = db.Column(db.Integer, db.ForeignKey('ingrediente.id'))
    autor = db.Column(db.Integer, db.ForeignKey('profile.id'))
    quantity = db.Column(db.Float, nullable=False)
...
class Ingrediente(db.Model):
    ...
    calory = db.Column(db.Integer, nullable=False)
    prices = db.relationship("Price", back_populates="ingrediente")
